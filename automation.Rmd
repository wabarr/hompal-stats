...
dplyr also provides a new way of chaining together commplicated operations with the `%>%` operator.  This prevents having to save intermediate steps, or to have a complicated series of nested functions.  For instance. 
