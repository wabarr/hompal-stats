...
Atomic vectors are very powerful, because many of the basic functions and operations in R are **vectorized**, meaning that they operate on all elements of a vector in sequence. 
...
You can assume that **most** of the base functions in R are vectorized. 
