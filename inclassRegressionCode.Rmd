...
Normally, when you are mutating columns, it assumes you want to do operations column-wise (like multiply a whole column of values by another whole column of values).  This works because the multiplication function in R is already smart enough to do the multiplication element-by element.  
