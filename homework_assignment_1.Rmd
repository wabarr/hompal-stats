...
#### **Note:** You should write your homework assignments as an R markdown document, and then use the knit button in RStudio to produce a stand-alone html document containing all your R code, as well as the results (including graphs) produced by your R code. Submit this single .html file on blackboard. Be sure that your document includes headers indicating which question you are answering (#1, #2, etc).

This [cheatsheet](http://www.rstudio.com/wp-content/uploads/2015/01/rmarkdown-cheatsheet.pdf) is helpful for using R markdown.

![knit button][knitbutton]
...
[knitbutton]: knit_button.png "the knit button in R studio"
