...
## Shared events = multiple simultaneous occurrences of simple events (Logical AND)  {.build}
...
**Note**:this is an operator function. You don't need (), it works like  `+` 

## complement  {.build}

The complement of a set is all the elements that are not in a set.  

The set $heads$ is all the elements that start with heads in the $tosses$ set.  

The complement of this set $heads^c$ represents all the other elements that don't start with heads. 
