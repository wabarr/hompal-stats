...
c. Create a new dataframe containing only the `XFB`, `OBB`, and `SIS` varibles
d.  Add a new column to the new dataframe that is the product of the `XFB`, `OBB`, and `SIS` variables.
...
b. Recreate the below figure exactly (including the theme) using the full cranial dataset. **Note**: you can control the size of the figures in your knitted document by including options in the code chunk. The default size is 6 for width and height.  The figure below is 16 wide and 9 high, like the following.
