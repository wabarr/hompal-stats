...
d) Finally, simulate stochastic fluctuations in environment reflecting the fact that different years have different environmental conditions. Reset `body.sizes` to its original values. Repeat the variable growth scenario, but each year multiply ALL individuals with a single scaling factor representing the productivity that particular year. Have that scaling factor be drawn from a normal distribution with mean 1 and variance 0.2. Save the results to `body.sizes.environmentalgrowth`.
