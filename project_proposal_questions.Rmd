...
For the presentation, you will be walking the class through the process of analyzing your data (including an Rmarkdown document that includes all R code used to make all visuals and to perform all statistical analysis). Your presentation should take approximately 25 minutes.
