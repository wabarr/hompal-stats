...
The most basic question to ask is where the central tendancy of this distribution is.  There are a variety of measures of central tendency.  
...
The geometric mean is defined as the $nth$ root of the product of $n$ numbers. The geometric mean is especially useful for summarizing values that are of different scale.  A common use is to calculate an overall size variable from a series of measuremetns that have very different scales (e.g. the length of a toe bone, and the length of a femur). 
...
The sample standard deviation refers to the square root of the variance.  It is probably the most commonly reported measure of spread.  Standard deviations are related to 95% confidence intervals in that 95% of the observations in a normal distribution will fall within $\pm$ 1.96 standard deviations.
