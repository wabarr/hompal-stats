...
a. Using `dplyr`, calculate the mean of the GOL measurement for each population group by sex.  (i.e., calculate the mean value separately for NORSE males and NORSE females, and the same for all groups).
