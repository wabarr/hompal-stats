...
This [cheatsheet](readings_pdf/rmarkdown-cheatsheet.pdf) is helpful for using R markdown.
...
3. Organizing data
    ...
    * This spreadsheet is not in a form that can be read into R.  Think about why not, keeping in mind [this information on data input](presentations/intro2R/intro2R.html#32).
