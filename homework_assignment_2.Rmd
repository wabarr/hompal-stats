...
a. Using `dplyr`, calculate the mean of the GOL measuremtn for each Population group by sex.  (i.e., give me a separate mean value for NORSE males and NORSE females).
