...
* do the ANOVA
* return the p value from the anova (hint: if you save the results of `lm()` in an object called `myMod`, you can calculate the p value using this code `pf(summary(myMod)$fstatistic[1],summary(myMod)$fstatistic[2],summary(myMod)$fstatistic[3], lower.tail = FALSE)`)
