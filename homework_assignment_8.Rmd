...
B.  Get rid of unwanted data. Select only the following columns: <span style="color:red;">ID, Sex, Population, BNL, MDH, EKB, ZOR, BAA, NBA</span>. Filter the dataset to only include individuals from the following populations: <span style="color:red;">BUSHMAN, PERU, NORSE, ZULU</span>. Use this filtered dataset for all remaining questions in this homework. 
