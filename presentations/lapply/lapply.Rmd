...
## Happy International Talk Like a Pirate Day 2016 {.build}

What is a pirate's favorite programming language?

R.......Although there are those that say his true love be the C.
...
*Important:* `X` will be converted to a matrix (which, like an atomic vector, only holds one type of data)

This can result in some of your columns being converted from numeric to character data. 
