...
Indexing is not just useful for extracting elements from a vector.  You can also use the assignment operator `<-` to replace particular elements in a vector.  Consider these examples:
