...
E.  Make a beautiful plot (using ggplot) of PC1 versus PC2 and another of PC2 versus PC3.  Make sure the points for each extant taxon are surrounded with a polygon to ease visualization. *Hint:* the `chull()` function can be used to compute convex hulls, which is the name for polygons that enclose groups of points.
